...
там кликается по нужная вкладка, недостающие архивы скачиваются в директорию,
указанную в дотфайле. Нужная Структура поддиректорий будет создана автоматически.
В дотфайле нужно указать профиль Firefox с залогином в Ревизоре.
